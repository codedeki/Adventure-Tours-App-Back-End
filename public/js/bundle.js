...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZGlqb25kbyIsImEiOiJja2J1NXQ4N2swNDd4MnFsYmF4OTl1dzZsIn0.tKn9SutsuIAbU79x2LdWfg';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/mapbox/light-v9',
    scrollZoom: false // center: [-118.113491, 34.111],
    // zoom: 10,
    // interactive: false,
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            if (res.data.status = 'success') location.reload(true); // reload fresh page from server
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  ...
  var tourId = e.target.dataset.tourId; // same as const tourId = e.target.dataset.tourId (data-tour-id gets converted to JS camelcase 'tourId' from tour.pug)
